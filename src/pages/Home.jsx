  ...
  return (
    <div>
      ...
      <section className="section">
        <h2>About Us</h2>
        <p>AAU Nightlife is your go-to platform for everything happening in and around Ambrose Alli University. We are dedicated to showcasing the vibrant student lifestyle by curating the latest events, job opportunities, and student blogs that matter most to the AAU community.</p>
        <p>Our mission is to connect students with experiences that enrich campus life — from nightlife parties and hangouts to career-building opportunities and creative storytelling. Whether you're looking for where the next rave is happening, searching for part-time jobs to support your studies, or simply wanting to share and read authentic student perspectives, AAU Nightlife is here to keep you informed and engaged.</p>
        <p>We pride ourselves on being more than just an entertainment hub. AAU Nightlife is a community-driven platform that amplifies student voices, supports local businesses, and promotes collaboration across campus. By blending fun, culture, and opportunity, we aim to redefine what it means to be a student at Ambrose Alli University.</p>
        <p>Join us as we continue to grow, inspire, and celebrate the energy of AAU.</p>
      </section>
